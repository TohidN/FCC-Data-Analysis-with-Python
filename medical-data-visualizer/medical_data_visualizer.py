...
def draw_cat_plot():
    ...
    df_cat['variable'] = df_cat['variable'].astype('category') # installed version of Seaborn is not compatible with numpy, updating it and using this code fixes it
...
def draw_heat_map():
    ...
    sns.heatmap(corr, mask=mask, square=True, linewidths=0.5, annot=True, fmt=".1f", center=0)
